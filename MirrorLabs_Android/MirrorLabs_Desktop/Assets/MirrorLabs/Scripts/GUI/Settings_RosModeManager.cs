...
namespace MirrorLabs{
    public class Settings_RosModeManager : MonoBehaviour
    {
        ...
        public void ConfirmRosModeSettings()
        {
            ...
            iterativeInterval = intervalSlider.value;
            jointStatePublisher.enabled = false;
            jointStateSubscriber.enabled = true;
            ...
            dropdownRobotManager.robotConfigs[dropdownRobotManager.robotDropdown.value].poseMode = poseStampDropdown.value;
            dropdownRobotManager.robotConfigs[dropdownRobotManager.robotDropdown.value].rosMode = rosModeDropdown.value;
            dropdownRobotManager.robotConfigs[dropdownRobotManager.robotDropdown.value].isPoseMode = isPoseMode;
            dropdownRobotManager.robotConfigs[dropdownRobotManager.robotDropdown.value].isIterativeMode = isIterativeMode;
            dropdownRobotManager.robotConfigs[dropdownRobotManager.robotDropdown.value].isManualPose = isManualPose;
            dropdownRobotManager.robotConfigs[dropdownRobotManager.robotDropdown.value].poseInterval = iterativeInterval;
