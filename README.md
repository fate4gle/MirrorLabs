...
Furthermore, the clients for JointStates and Odometry have extensive comments which will appear as information boxes when hovering above them in the inspector, using these bits of information will make it easier to get started.

For further information reagrding the MQTT-Module, please visit the [DTStacks-Wiki](https://github.com/fate4gle/DTStacks/wiki). 
